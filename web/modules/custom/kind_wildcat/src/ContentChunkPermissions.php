...
/**
 * Provides dynamic permissions for Content chunk of different types.
 *
 * @ingroup kind_wildcat
 *
 */
class ContentChunkPermissions{
   ...
   *
   * @return array
   *   The ContentChunk by bundle permissions.
   *   @see \Drupal\user\PermissionHandlerInterface::getPermissions()
   */
  public function generatePermissions() {
    $perms = [];

    foreach (ContentChunkType::loadMultiple() as $type) {
   ...
   *
   * @param \Drupal\kind_wildcat\Entity\ContentChunkType $type
   *   The ContentChunk type.
   *
   * @return array
   *   An associative array of permission names and descriptions.
   */
  protected function buildPermissions(ContentChunkType $type) {
    $type_id = $type->id();
